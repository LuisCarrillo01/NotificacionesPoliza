...
```bash
python3 .claude/skills/go/scripts/search.py "<project description>" --arch-system -p "ProjectName"
```
...
python3 .claude/skills/go/scripts/search.py "functional options config" --domain pattern

# Error handling approach
python3 .claude/skills/go/scripts/search.py "error wrapping context" --domain error

# Concurrency patterns
python3 .claude/skills/go/scripts/search.py "worker pool bounded" --domain concurrency

# Performance tips
python3 .claude/skills/go/scripts/search.py "http connection pooling" --domain perf

# Testing patterns
python3 .claude/skills/go/scripts/search.py "table driven httptest" --domain test
```

### 4. Stack Guidelines
If using a specific framework/stack:
```bash
python3 .claude/skills/go/scripts/search.py "middleware authentication" --stack web-gin
python3 .claude/skills/go/scripts/search.py "cobra subcommands config" --stack cli
python3 .claude/skills/go/scripts/search.py "interceptor logging" --stack grpc
```
...
python3 .claude/skills/rust/scripts/search.py "builder pattern" --domain pattern

# Crate recommendations
python3 .claude/skills/rust/scripts/search.py "http client" --domain crate

# Error handling strategies
python3 .claude/skills/rust/scripts/search.py "custom error type" --domain error

# Performance optimization
python3 .claude/skills/rust/scripts/search.py "zero cost abstraction" --domain perf

# Testing patterns
python3 .claude/skills/rust/scripts/search.py "integration test" --domain test

# Concurrency patterns
python3 .claude/skills/rust/scripts/search.py "channel mpsc" --domain concurrency

# Trait design
python3 .claude/skills/rust/scripts/search.py "trait object dyn" --domain trait

# Architecture patterns
python3 .claude/skills/rust/scripts/search.py "domain driven design" --domain arch

# Idioms and best practices
python3 .claude/skills/rust/scripts/search.py "ownership borrowing" --domain idiom

# Anti-patterns to avoid
python3 .claude/skills/rust/scripts/search.py "clone overuse" --domain anti

# Tooling
python3 .claude/skills/rust/scripts/search.py "clippy cargo fmt" --domain tooling

# Module system
python3 .claude/skills/rust/scripts/search.py "workspace crate" --domain module

# Unsafe / FFI
python3 .claude/skills/rust/scripts/search.py "raw pointer ffi" --domain unsafe
```
...
# Actix-web patterns
python3 .claude/skills/rust/scripts/search.py "handler actor" --stack web-actix

# Warp filters
python3 .claude/skills/rust/scripts/search.py "filter compose" --stack web-warp

# Rocket framework
python3 .claude/skills/rust/scripts/search.py "guard fairing" --stack web-rocket

# gRPC with tonic
python3 .claude/skills/rust/scripts/search.py "interceptor streaming" --stack grpc

# Database (SQLx, Diesel)
python3 .claude/skills/rust/scripts/search.py "query macro transaction" --stack database

# CLI (clap, indicatif)
python3 .claude/skills/rust/scripts/search.py "subcommand progress" --stack cli

# Authentication
python3 .claude/skills/rust/scripts/search.py "jwt argon2" --stack auth

# Async runtime patterns
python3 .claude/skills/rust/scripts/search.py "spawn task join" --stack async-runtime

# WebAssembly
python3 .claude/skills/rust/scripts/search.py "wasm bindgen" --stack wasm

# Embedded systems
python3 .claude/skills/rust/scripts/search.py "no std hal" --stack embedded
```

### Architecture System
```bash
python3 .claude/skills/rust/scripts/search.py "rest api postgres auth" --arch-system -p "MyAPI"
```

### Auto-detect Domain
```bash
# No domain — auto-detects from query keywords
python3 .claude/skills/rust/scripts/search.py "how to handle errors with Result"
```
